<footer>
		<div class="container">
			<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
				<h4>About Us</h4>
				<p>MTG:Collect is a site for Magic: The Gathering players and clubs where they can keep tabs on their collections, decks and tournaments</p>						
				<div class="contact-info">
					<ul>
						<li><i class="fa fa-home fa"></i>Trg Dositeja Obradovica 3, 21000 Novi Sad</li>
						<li><i class="fa fa-phone fa"></i>065/905-8057</li>
						<li><i class="fa fa-envelope fa"></i> info@MTGCollect.com</li>
					</ul>
				</div>
			</div>
